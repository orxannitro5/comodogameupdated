...
const AddBlog = ({onSubmitClickHnd,onBackBtnHnd})=>{
    const [imageURL, setImageURL] = useState("");
    const [title,setTitle] = useState("")
    const [text, setText] = useState("")
    const [date,setDate] = useState("")
    const [likes,setLikes] = useState("")
    const [commentary,setCommentray] = useState("")
    ...
    return (
        <div className="add-game-main">
            <form className="add-form" onSubmit={onSubmitBtnClickHnd}>
                <h3 className="add-form-title">Add Blog Form</h3>
                ...
                <div className="back-add-buttons">
                    ...
                    <input className="add-btn" type="submit" value="Add Blog" />
                </div>
            </form>
        </div>
    )
